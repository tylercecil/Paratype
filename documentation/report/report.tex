...
\section{Problems Induced by Parallelization}
	\subsection{Making Halting Deterministic}
		...
		The updated iteration of halting requires more keeping track of state. Actors which do not have parents only need to send to their children and they are completed. The signaling of the completion is done through a flag in one of the communication messages.
