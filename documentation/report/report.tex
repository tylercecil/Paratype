...
repeated 30 times. The tests were run on \texttt{edison.cs.nmt.edu}, a machine
with 12 CPU threads and 6 CPU cores. Even though there was huge variation for a
fixed problem size and a fixed number of processors, speedup was obtained by
averaging the time taken for one processor.
