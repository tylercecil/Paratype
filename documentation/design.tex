...
Saying that we evaluate types as an actor model is hardly enough information to
get started. In this document, we attempt to describe and justify our
algorithm, both for our and the reader's benefit.
