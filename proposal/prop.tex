...
\emph{Paratype} can provide a speedup for modern strongly typed
compilers. More importantly, it provides us with a new way of
thinking about types: a way that is inherintly parallel. Parallel type
analysis opens up oportunities for parallel theorem provers, parallel
code analysis, and any logical task that can be carried out with type
theory. The task, however, is a non-trivially one. Communications
that will take place are cyclic, simi-structured at best, and provides
no clear ``halting'' condition. It will be the responcibilities of
each of us to takel these problems in a clear and maintainable
mannar. The parallel code involved will manage up-types, down-types,
...
\ganttbar{Implement actors, contexts, type DAGs}{2014-04-10}{2014-04-14}\\
...
\ganttmilestone{Deterministic halting}{2014-04-20}{2014-04-20}\\
\ganttbar{Partial contexts}{2014-04-17}{2014-04-23}\\
\ganttmilestone{Partial context resolution test}{2014-04-23}{2014-04-23}\\
\ganttbar{Error types}{2014-04-19}{2014-04-25}\\
\ganttmilestone{Error types test}{2014-04-25}{2014-04-25}\\
\ganttbar{Monitor}{2014-04-19}{2014-04-25}\\

\ganttbar{Report and Presentation}{2014-04-27}{2014-05-02}
