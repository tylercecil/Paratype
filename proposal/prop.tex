...
\lstdefinestyle{paratype}{
	...
	keywords={func,inherits,implements,throws,type,typeclass,constrain,to},
...
<typeclass-name> ::= <upper-letter>, \{<upper-letter> | <lower-letter>\};
...
<typeclass-decl> ::= `typeclass ', <typeclass-name>, 
	[<typeclass-inherit>];

<func-decl> ::= `func ', <func-name>, 
	[<func-constraints>], <func-args>, [<func-errors>];
